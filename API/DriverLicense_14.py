...
def get_file_content(filePath):
    with open('C:\Users\I332487\Desktop\DriverLicense14.jpg', 'rb') as fp:
        return fp.read()


#调用驾驶证识别 API
result = aipOcr.drivingLicense(get_file_content('C:\Users\I332487\Desktop\DriverLicense14.jpg'))
